...
#Preview {
    RegistrationView(dismiss: <#T##arg#>, authService: <#T##arg#>, name: <#T##arg#>, email: <#T##arg#>, phone: <#T##arg#>, password: <#T##arg#>, confirmPassword: <#T##arg#>, errorMessage: <#T##String?#>, showError: <#T##arg#>, isRegistering: <#T##arg#>, registrationSuccess: <#T##arg#>)
}
